namespace Library.Migrations
{
    ...
    public partial class M1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Title = c.String(nullable: false, maxLength: 14),
                        ISBN = c.Int(nullable: false),
                        Yeare = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.UserAs", t => t.UserID)
                .Index(t => t.UserID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Books", "UserID", "dbo.UserAs");
            DropForeignKey("dbo.Messages", "UserID", "dbo.UserAs");
